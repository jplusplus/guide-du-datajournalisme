...
Ce tableau nous présente les montants par ordre décroissant, mais il ne nous dit pas grandchose des tendances sous-jacentes du classement. La figure 5-7 est une autre visualisation des données, un type de graphique « à points », sur lequel on peut voir tout ce qui est affiché dans le tableau plus les tendances au sein du champ. Par exemple, le graphique à points nous permet de comparer immédiatement la distance entre Obama et Romney, ou Romney et Perry, sans avoir à soustraire les valeurs. (Remarque : ce graphique à points a été créé avec R. Vous trouverez des liens vers le code source à la fin de ce chapitre.) 
